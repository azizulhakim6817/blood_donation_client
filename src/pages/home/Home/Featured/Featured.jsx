  ...
  return (
    <section className=" py-16 sm:py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-gray-600 dark:text-white max-w-2xl mx-auto mb-12 text-[15px]">
        ...
        <div className="grid gap-8 md:grid-cols-3">
          {/* Card 1 */}
          <div className="rounded-2xl shadow-lg p-8 hover:shadow-2xl transition">
          ...
          <div className="  rounded-2xl shadow-lg p-8 hover:shadow-2xl transition">
            ...
            <h3 className="text-xl text-secondary dark:text-white font-semibold mb-3">
              Build Community
            </h3>
          ...
          <div className="  rounded-2xl shadow-lg p-8 hover:shadow-2xl transition">
            ...
            <h3 className="text-xl text-secondary font-semibold mb-3 dark:text-white">
              Emergency Support
            </h3>
            <p className="text-gray-600 text-[14px] dark:text-white">
